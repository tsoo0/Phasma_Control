...
int			TriggerSettings_setup_state = 4001;	//WARNING, if this gets changed here, it must also be changed in the mastercontrol loop repeat cycle subroutine
int			Trigger_panel;
...
void Write_MasterTrigger(void)
{
	...
	GetCtrlVal (Trigger_panel, Trigger_SRSDG2_V_High_EF,&Bias1_High);
	GetCtrlVal (Trigger_panel, Trigger_SRSDG2_V_Low_EF,&Bias1_Low);
	GetCtrlVal (Trigger_panel, Trigger_SRSDG2_ChannelG,&Bias2);	Bias2=Bias2/1.0E6;
	GetCtrlVal (Trigger_panel, Trigger_SRSDG2_ChannelH,&Bias2_Pulse_Length);
	GetCtrlVal (Trigger_panel, Trigger_SRSDG2_V_High_GH,&Bias2_High);
	GetCtrlVal (Trigger_panel, Trigger_SRSDG2_V_Low_GH,&Bias2_Low);
	...
	GetCtrlVal (Trigger_panel, Trigger_SRSDG3_V_High_CD,&ParaTS_High);
	GetCtrlVal (Trigger_panel, Trigger_SRSDG3_V_Low_CD,&ParaTS_Low);
	GetCtrlVal (Trigger_panel, Trigger_SRSDG3_ChannelE,&PLIF);	PLIF=PLIF/1.0E6;
	GetCtrlVal (Trigger_panel, Trigger_SRSDG3_ChannelF,&PLIF_Pulse_Length);
	GetCtrlVal (Trigger_panel, Trigger_SRSDG3_V_High_EF,&PLIF_High);
	GetCtrlVal (Trigger_panel, Trigger_SRSDG3_V_Low_EF,&PLIF_Low);
	GetCtrlVal (Trigger_panel, Trigger_SRSDG3_ChannelG,&Other);
	...
	strcat(outfilename, "MasterTrigger.txt");
	outfile=fopen (outfilename, "w");

	fprintf(outfile,"Total_Cycle_Time, Laser_Warmup, Laser_Warmup_Pulse_Length, Laser_Warmup_High, Laser_Warmup_Low, Gun_Charging, Gun_Charging_Pulse_Length, Gun_Charging_High, Gun_Charging_Low, Astrella_Synch,");
	fprintf(outfile,"Astrella_Synch_Pulse_Length,Astrella_Synch_High,Astrella_Synch_Low,iCCD_Shutter,iCCD_Shutter_Pulse_Length,iCCD_Shutter_High,iCCD_Shutter_Low,Gas_Puff,Gas_Puff_Pulse_Length,Gas_Puff_High,Gas_Puff_Low,Arc,");
	fprintf(outfile,"Arc_Pulse_Length,Arc_High,Arc_Low,Bias1,Bias1_Pulse_Length,Bias1_High,Bias1_Low,Bias2,Bias2_Pulse_Length,Bias2_High,Bias2_Low,PerpTS,PerpTS_Pulse_Length,PerpTS_High,PerpTS_Low,ParaTS,ParaTS_Pulse_Length,");
	fprintf(outfile,"ParaTS_High,ParaTS_Low,PLIF,PLIF_Pulse_Length,PLIF_High,PLIF_Low,Other,Other_Pulse_Length,Other_High,Other_Low\n");
	fprintf(outfile,"%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f\n",
			Total_Cycle_Time,Laser_Warmup,Laser_Warmup_Pulse_Length,Laser_Warmup_High,Laser_Warmup_Low,Gun_Charging,Gun_Charging_Pulse_Length,Gun_Charging_High,Gun_Charging_Low,Astrella_Synch,Astrella_Synch_Pulse_Length,
			Astrella_Synch_High,Astrella_Synch_Low,iCCD_Shutter,iCCD_Shutter_Pulse_Length,iCCD_Shutter_High,iCCD_Shutter_Low,Gas_Puff,Gas_Puff_Pulse_Length,Gas_Puff_High,Gas_Puff_Low,Arc,Arc_Pulse_Length,Arc_High,Arc_Low,
			Bias1,Bias1_Pulse_Length,Bias1_High,Bias1_Low,Bias2,Bias2_Pulse_Length,Bias2_High,Bias2_Low,PerpTS,PerpTS_Pulse_Length,PerpTS_High,PerpTS_Low,ParaTS,ParaTS_Pulse_Length,ParaTS_High,ParaTS_Low,PLIF,PLIF_Pulse_Length,
			PLIF_High,PLIF_Low,Other,Other_Pulse_Length,Other_High,Other_Low);

 	//Close trigger settings file
	fclose (outfile);
