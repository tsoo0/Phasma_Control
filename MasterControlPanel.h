...
#define  MasterCont_MasterTrigger_Data    50      /* control type: binary, callback function: MasterTrigger_Data_Switch */
#define  MasterCont_MagField_Data         51      /* control type: binary, callback function: MagField_Data_Switch */
#define  MasterCont_Housekeeping_Data     52      /* control type: binary, callback function: HousekeepingData_Switch */
#define  MasterCont_Quantum_Settings      53      /* control type: command, callback function: QBS_Settings */
#define  MasterCont_PlasmaGun_Data        54      /* control type: binary, callback function: (none) */
#define  MasterCont_Quantum_Status        55      /* control type: binary, callback function: Quantum_Activate */
#define  MasterCont_ContinLIF_Settings    56      /* control type: command, callback function: ContinLIF_Settings */
#define  MasterCont_PulsedLIF_Settings    57      /* control type: command, callback function: PulsedLIF_Settings */
#define  MasterCont_MagProbe_Settings     58      /* control type: command, callback function: MagProbe_Settings */
#define  MasterCont_Bdot_Status           59      /* control type: binary, callback function: Bdot_Activate */
#define  MasterCont_SAVEDATATOMDS_2       60      /* control type: textMsg, callback function: (none) */
#define  MasterCont_PulsedLIF_Status      61      /* control type: binary, callback function: PulsedLIF_Activate */
#define  MasterCont_TripleProbe_Settings  62      /* control type: command, callback function: TripleProbe_Settings */
#define  MasterCont_TripleProbe_Status    63      /* control type: binary, callback function: TripleProbe_Activate */
#define  MasterCont_DoubleProbet_Settings 64      /* control type: command, callback function: DoubleProbe_Settings */
#define  MasterCont_DoubleProbe_Status    65      /* control type: binary, callback function: DoubleProbe_Activate */
#define  MasterCont_TS_Settings           66      /* control type: command, callback function: ThomsonsScattering_Settings */
#define  MasterCont_TS_Status             67      /* control type: binary, callback function: TS_Activate */
#define  MasterCont_Helicon_Settings_But  68      /* control type: command, callback function: Helicon_Settings */
#define  MasterCont_HeliconSource_Status  69      /* control type: binary, callback function: HeliconSource_Activate */
#define  MasterCont_MagField_Settings_But 70      /* control type: command, callback function: MagField_Settings */
#define  MasterCont_MagField_Status       71      /* control type: binary, callback function: MagField_Activate_Switch */
#define  MasterCont_House_Settings_But    72      /* control type: command, callback function: Housekeeping_Settings */
#define  MasterCont_Housekeeping_Status   73      /* control type: binary, callback function: Housekeeping_Activate */
#define  MasterCont_Gun_Settings_But      74      /* control type: command, callback function: Gun_Settings */
#define  MasterCont_PlasmaGun_Status      75      /* control type: binary, callback function: PlasmaGun_Activate */
#define  MasterCont_CURRENTDIAGNOSTICPO_2 76      /* control type: textMsg, callback function: (none) */
#define  MasterCont_TextMessage6_2        77      /* control type: textMsg, callback function: (none) */
#define  MasterCont_TextMessage6          78      /* control type: textMsg, callback function: (none) */
#define  MasterCont_TextMessage5          79      /* control type: textMsg, callback function: (none) */
#define  MasterCont_CURRENTDIAGNOSTICPOSI 80      /* control type: textMsg, callback function: (none) */
#define  MasterCont_ARMED                 81      /* control type: textMsg, callback function: (none) */
#define  MasterCont_SAVEDATATOMDS         82      /* control type: textMsg, callback function: (none) */
#define  MasterCont_POWERUPSYSTEM         83      /* control type: textMsg, callback function: (none) */
#define  MasterCont_AutoCycle_Status      84      /* control type: command, callback function: AutoCycle */
#define  MasterCont_TempDiag_Arm          85      /* control type: LED, callback function: (none) */
#define  MasterCont_ManualMatLab          86      /* control type: command, callback function: ManualMatLab */
#define  MasterCont_ManualProbe_Advance   87      /* control type: command, callback function: ManualProbe_Advance */
#define  MasterCont_ManualTrigger_Status  88      /* control type: command, callback function: ManualTrigger */
#define  MasterCont_ManualArm_Status      89      /* control type: command, callback function: ManualArm */
#define  MasterCont_RFEA_Arm              90      /* control type: LED, callback function: (none) */
#define  MasterCont_Lightwave_Arm         91      /* control type: LED, callback function: (none) */
#define  MasterCont_Bdot_Arm              92      /* control type: LED, callback function: (none) */
#define  MasterCont_McPherson209_Arm      93      /* control type: LED, callback function: (none) */
#define  MasterCont_Ocean_Arm             94      /* control type: LED, callback function: (none) */
#define  MasterCont_SPLITTER_8            95      /* control type: splitter, callback function: (none) */
#define  MasterCont_PhotronCamera_Arm     96      /* control type: LED, callback function: (none) */
#define  MasterCont_TripleProbe_Arm       97      /* control type: LED, callback function: (none) */
#define  MasterCont_Photodiode_Arm        98      /* control type: LED, callback function: (none) */
#define  MasterCont_Lang_Arm              99      /* control type: LED, callback function: (none) */
#define  MasterCont_Quantum_Arm           100     /* control type: LED, callback function: (none) */
#define  MasterCont_DoubleProbe_Arm       101     /* control type: LED, callback function: (none) */
#define  MasterCont_ContinLIF_Arm         102     /* control type: LED, callback function: (none) */
#define  MasterCont_PulsedLIF_Arm         103     /* control type: LED, callback function: (none) */
#define  MasterCont_TS_Arm                104     /* control type: LED, callback function: (none) */
#define  MasterCont_PlasmaGun_Arm         105     /* control type: LED, callback function: (none) */
#define  MasterCont_MasterTrigger_Arm     106     /* control type: LED, callback function: (none) */
#define  MasterCont_MagField_Arm          107     /* control type: LED, callback function: (none) */
#define  MasterCont_Helicon_Arm           108     /* control type: LED, callback function: (none) */
#define  MasterCont_Housekeeping_Arm      109     /* control type: LED, callback function: (none) */
#define  MasterCont_CycleRepeat           110     /* control type: numeric, callback function: (none) */
#define  MasterCont_MatLab_Status         111     /* control type: binary, callback function: Auto_Run_Matlab */
#define  MasterCont_ProbeAdvance_Status   112     /* control type: binary, callback function: Auto_Advance_Probes */
#define  MasterCont_SPLITTER              113     /* control type: splitter, callback function: (none) */
#define  MasterCont_SPLITTER_5            114     /* control type: splitter, callback function: (none) */
#define  MasterCont_SPLITTER_6            115     /* control type: splitter, callback function: (none) */
#define  MasterCont_SPLITTER_4            116     /* control type: splitter, callback function: (none) */
#define  MasterCont_SPLITTER_3            117     /* control type: splitter, callback function: (none) */
#define  MasterCont_SPLITTER_2            118     /* control type: splitter, callback function: (none) */
#define  MasterCont_HousekeepingPlot      119     /* control type: graph, callback function: (none) */
#define  MasterCont_MDS_Shot              120     /* control type: numeric, callback function: (none) */
#define  MasterCont_RFEA_Radial           121     /* control type: numeric, callback function: (none) */
#define  MasterCont_QBS_Z                 122     /* control type: numeric, callback function: (none) */
#define  MasterCont_Quantum_Y             123     /* control type: numeric, callback function: (none) */
#define  MasterCont_Quantum_X             124     /* control type: numeric, callback function: (none) */
#define  MasterCont_PLIF_Laser_Wavelength 125     /* control type: numeric, callback function: (none) */
#define  MasterCont_FluctProbe_Radial     126     /* control type: numeric, callback function: (none) */
#define  MasterCont_TripleProbe_Radial    127     /* control type: numeric, callback function: (none) */
#define  MasterCont_Gun2_Radial           128     /* control type: numeric, callback function: (none) */
#define  MasterCont_Gun1_Radial           129     /* control type: numeric, callback function: (none) */
#define  MasterCont_Magnetic_Radial       130     /* control type: numeric, callback function: (none) */
#define  MasterCont_Interval              131     /* control type: numeric, callback function: SetMasterClock */
#define  MasterCont_CountdownClock        132     /* control type: scale, callback function: (none) */
...
int  CVICALLBACK manual_disarm_all(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
...
int  CVICALLBACK MasterTrigger_Data_Switch(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
...
int  CVICALLBACK PyUpdateHandleStatus(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
int  CVICALLBACK QBS_Settings(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
...
int  CVICALLBACK toggle_push_to_mds(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
