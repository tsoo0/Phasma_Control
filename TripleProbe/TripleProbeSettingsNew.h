...
#define  Photodiode_ACQ2106_TRG_DELAY     15      /* control type: numeric, callback function: ACQ2106_TRG_DELAY_SET */
...
int  CVICALLBACK ACQ2106_TRG_DELAY_SET(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
