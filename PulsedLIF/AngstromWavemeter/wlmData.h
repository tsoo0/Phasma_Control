...
// Mode Constants for Callback-Export and WaitForWLMEvent-function
	...
	const int	cmiExposureValue21 = 8;
	...
	const int	cmiAnalogOut1 = 67;
	const int	cmiAnalogOut2 = 142;
	const int	cmiMin11 = 22;
...
// but still can be combined with "Measurement Action Addition Constants". See below.)
	const int	cCtrlStopAll = 0;
	const int	cCtrlStartAdjustment = 1;
	const int	cCtrlStartMeasurement = 2;
...
// Pattern- and Analysis Constants
	...
	const int	cAnalysisDisable = 0;
	const int	cAnalysisEnable = 1;
	...
	const int	cSignalAnalysisX = 4;
	const int	cSignalAnalysisY = 4 + 1;
...
// Return errorvalues of GetFrequency, GetWavelength and GetWLMVersion
	...
	const int	ErrMaxErr = -15;

// Return errorvalues of GetTemperature and GetPressure
	const int	ErrTemperature = -1000;
	const int	ErrTempNotMeasured = -1000 + 0;
	const int	ErrTempNotAvailable = -1000 + -6;
	const int	ErrTempWlmMissing = -1000 + -5;
...
// Return errorvalues of GetDistance
	...
	const int	ErrDistanceNotAvailable = -1000000000 + -6;
	const int	ErrDistanceWlmMissing = -1000000000 + -5;
