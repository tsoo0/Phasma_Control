...
#define	PIC_ERROR_CONVERSION_OF_STRING	25	/*	Conversion of string. Multi-byte and Unicode */
...
#define	PIC_FUNCTION_OFF			0
#define	PIC_FUNCTION_ON				1
...
#define PIC_INSTSET_AVX2	0x00000008
...
#ifdef UNICODE
#define PIC_RAWFileSave  PIC_RAWFileSaveW
#else
#define PIC_RAWFileSave  PIC_RAWFileSaveA
#endif // !UNICODE
...
#ifdef UNICODE
#define PIC_RAW16FileSave  PIC_RAW16FileSaveW
#else
#define PIC_RAW16FileSave  PIC_RAW16FileSaveA
#endif // !UNICODE

unsigned long WINAPI
PIC_MRAWFileSaveOpenA(
		LPCSTR					lpszFileName,
		PPIC_IMAGE_BUFF_INFO	pInfo,
		long					nMaxFrameNum,
		unsigned long			*pErrorCode
...
#ifdef UNICODE
#define PIC_MRAWFileSaveOpen  PIC_MRAWFileSaveOpenW
#else
#define PIC_MRAWFileSaveOpen  PIC_MRAWFileSaveOpenA
#endif // !UNICODE

unsigned long WINAPI
PIC_MRAWFileSaveOpenWithA(
		PIC_MRAW				*pPicMRaw,
		LPCSTR					lpszFileName,
		PPIC_IMAGE_BUFF_INFO	pInfo,
		long					nMaxFrameNum,
...
#ifdef UNICODE
#define PIC_MRAWFileSaveOpenWith  PIC_MRAWFileSaveOpenWithW
#else
#define PIC_MRAWFileSaveOpenWith  PIC_MRAWFileSaveOpenWithA
#endif // !UNICODE
...
#ifdef UNICODE
#define PIC_MRAW16FileSaveOpen  PIC_MRAW16FileSaveOpenW
#else
#define PIC_MRAW16FileSaveOpen  PIC_MRAW16FileSaveOpenA
#endif // !UNICODE

unsigned long WINAPI
PIC_MRAW16FileSaveOpenWithA(
		PIC_MRAW				*pPicMRaw,
		LPCSTR					lpszFileName,
		PPIC_IMAGE_BUFF_INFO	pInfo,
		PIC_RAW_BITDEPTH		pic_depth,
...
#ifdef UNICODE
#define PIC_MRAW16FileSaveOpenWith  PIC_MRAW16FileSaveOpenWithW
#else
#define PIC_MRAW16FileSaveOpenWith  PIC_MRAW16FileSaveOpenWithA
#endif // !UNICODE
...
#ifdef UNICODE
#define PIC_MTIFFFileSaveOpen  PIC_MTIFFFileSaveOpenW
#else
#define PIC_MTIFFFileSaveOpen  PIC_MTIFFFileSaveOpenA
#endif // !UNICODE
...
#ifdef UNICODE
#define PIC_MTIFF16FileSaveOpen  PIC_MTIFF16FileSaveOpenW
#else
#define PIC_MTIFF16FileSaveOpen  PIC_MTIFF16FileSaveOpenA
#endif // !UNICODE
...
#ifdef UNICODE
#define PIC_RAWFileLoad  PIC_RAWFileLoadW
#else
#define PIC_RAWFileLoad  PIC_RAWFileLoadA
#endif // !UNICODE
...
#ifdef UNICODE
#define PIC_RAWFileLoad2  PIC_RAWFileLoad2W
#else
#define PIC_RAWFileLoad2  PIC_RAWFileLoad2A
#endif // !UNICODE

unsigned long WINAPI
PIC_MRAWFileLoadOpenA(
		LPCSTR					lpszFileName,
		PIC_IMAGE_BUFF_INFO		*pInfo,
		PIC_MRAW				*pPicMRaw,
		PIC_RAW_BITDEPTH		pic_depth,
...
#ifdef UNICODE
#define PIC_MRAWFileLoadOpen  PIC_MRAWFileLoadOpenW
#else
#define PIC_MRAWFileLoadOpen  PIC_MRAWFileLoadOpenA
#endif // !UNICODE

unsigned long WINAPI
PIC_MRAWFileLoadOpen2A(
		LPCSTR					lpszFileName,
		PIC_IMAGE_BUFF_INFO		*pInfo,
		PIC_MRAW				*pPicMRaw,
		PIC_RAW_BITDEPTH		pic_depth,
...
#ifdef UNICODE
#define PIC_MRAWFileLoadOpen2  PIC_MRAWFileLoadOpen2W
#else
#define PIC_MRAWFileLoadOpen2  PIC_MRAWFileLoadOpen2A
#endif // !UNICODE
...
unsigned long WINAPI 
PIC_Speeder2FileGetHeaderA(
						  LPCSTR			lpszFileName,
						  PIC_VID			*pPicVID,
						  unsigned long		*pErrorCode);

unsigned long WINAPI
PIC_Speeder2FileGetHeaderW(
						LPCWSTR			lpszFileName,
						PIC_VID			*pPicVID,
						unsigned long		*pErrorCode);

#ifdef UNICODE
#define PIC_Speeder2FileGetHeader  PIC_Speeder2FileGetHeaderW
#else
#define PIC_Speeder2FileGetHeader  PIC_Speeder2FileGetHeaderA
#endif // !UNICODE
