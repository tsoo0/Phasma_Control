...
#define PDC_ERROR_ACCEPT_ONLY_SAMPLING_MODE_QUALITY	27	/*  Accept Only in SAMPLING_MODE_QUALITY  */
...
#define PDC_ERROR_OPENGL 70 /* opengl error */
...
#define PDC_INT_OPEN_ALREADY            2009
