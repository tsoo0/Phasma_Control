...
#ifdef UNICODE
#define PDC_GetVersionString  PDC_GetVersionStringW
#else
#define PDC_GetVersionString  PDC_GetVersionStringA
#endif // !UNICODE
...
unsigned long PDCAPI
PDC_GetFASTDriveRecOnCmdTrigFrames(
    unsigned long			nDeviceNo,
    unsigned long           nSlotNo,
    unsigned long			nDataNo,
    void                    *pTrigFrames,
...
unsigned long PDCAPI PDC_GRAWFileSaveOpenA(
    unsigned long            nDeviceNo,
    unsigned long            nChildNo,
    PPDC_SAVE_FRAME_INFO     pFrameInfo,
    LPCSTR                   pPath,
    PPDC_GRAW                 pPdcGRaw,
    PPDC_GRAW_OPTION_INFO    pOptionInfo,
    unsigned long* pErrorCode
);

unsigned long PDCAPI PDC_GRAWFileSaveOpenW(
    unsigned long			nDeviceNo,
    unsigned long			nChildNo,
    PPDC_SAVE_FRAME_INFO	pFrameInfo,
    LPCWSTR					pPath,
...
#ifdef UNICODE
#define	PDC_GRAWFileSaveOpen	PDC_GRAWFileSaveOpenW
#else
#define	PDC_GRAWFileSaveOpen	PDC_GRAWFileSaveOpenA
#endif

unsigned long PDCAPI PDC_GRAWFileSave(
    unsigned long	nDeviceNo,
    unsigned long	nChildNo,
    long			nFrameNo,
    PPDC_GRAW       pPdcGRaw,
...
unsigned long PDCAPI PDC_GRAWFileSaveCancel(
    unsigned long	nDeviceNo,
    unsigned long	nChildNo,
    unsigned long* pErrorCode
);

unsigned long PDCAPI PDC_GRAWFileSaveClose(
    unsigned long	nDeviceNo,
    unsigned long	nChildNo,
    PPDC_GRAW pPdcGRaw,
    unsigned long* pErrorCode
...
unsigned long PDCAPI PDC_GRAWFileLoadOpenW(
    LPCWSTR			pPath,
    PPDC_GRAW       pPdcGRaw,
    unsigned long* pErrorCode
);

unsigned long PDCAPI PDC_GRAWFileLoadOpenA(
    LPCSTR			pPath,
    PPDC_GRAW       pPdcGRaw,
    unsigned long* pErrorCode
);
...
#ifdef UNICODE
#define PDC_GRAWFileLoadOpen  PDC_GRAWFileLoadOpenW
#else
#define PDC_GRAWFileLoadOpen  PDC_GRAWFileLoadOpenA
#endif

unsigned long PDCAPI PDC_GRAWFileLoadClose(
    PPDC_GRAW      pPdcGRaw,
    unsigned long* pErrorCode
);

unsigned long PDCAPI PDC_GRAWFileLoad(
    PPDC_GRAW       pPdcGRaw,
    void*           pBuff,
    long			nFrame,
    unsigned long*  pErrorCode
...
unsigned long PDCAPI PDC_GRAWGetBayerConvertInfo(
    PPDC_GRAW               pPdcGRaw,
    PPDC_BAYER_CONVERT_INFO pBayerInfo,
    unsigned long*          pErrorCode
);

unsigned long PDCAPI PDC_FlushLog(
    unsigned long* pErrorCode
);

unsigned long PDCAPI PDC_SetCorrectionDataErasureReservation(
    unsigned long  nDeviceNo,
    unsigned long  nChildNo,
    char           nFlag,
    unsigned long* pErrorCode
...
unsigned long PDCAPI PDC_GetCorrectionDataErasureReservation(
    unsigned long  nDeviceNo,
    unsigned long  nChildNo,
    char*          pFlag,
    unsigned long* pErrorCode
...
#ifdef UNICODE
#define PDC_GetMACAddressString  PDC_GetMACAddressStringW
#else
#define PDC_GetMACAddressString  PDC_GetMACAddressStringA
#endif // !UNICODE

unsigned long PDCAPI PDC_GetShadingProcessType(
    unsigned long nDeviceNo,
    unsigned long nChildNo,
    unsigned long* pType,
    unsigned long* pErrorCode);

unsigned long PDCAPI PDC_GetDefaultLUTMode(
    unsigned long	nDeviceNo,
    unsigned long   nChildNo,
    unsigned long*  pMode,
    unsigned long* pErrorCode
...
unsigned long PDCAPI PDC_GetLowLightModeList(
    unsigned long   nDeviceNo,
    unsigned long*  pSize,
    unsigned long*  pList,
    unsigned long*  pErrorCode
