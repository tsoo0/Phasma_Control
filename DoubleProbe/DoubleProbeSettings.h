...
#define  DoublePrbe                       1
#define  DoublePrbe_DBPRB_LeCroyAddress2  2       /* control type: ring, callback function: (none) */
#define  DoublePrbe_DBPRB_LeCroyAddress1  3       /* control type: ring, callback function: (none) */
