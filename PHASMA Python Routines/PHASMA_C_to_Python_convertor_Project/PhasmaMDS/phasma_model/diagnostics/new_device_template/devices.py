from ...device_classes.MSO5104 import MSO5104  # import a predefined class for a generic MSO5104 oscilloscope
from ...device_classes.VX4244 import VX4244

diagname = "HOUSEKEEPING" # 12-character limit, case insensitive (will be converted to uppercase); 
                          # MDS name of diagnostic system that every device in this file is a member of
devtag = "HOUSE"    # shorthand name for this diagnostic used within MDS
devgroup = "DATA"
