...
basedir = "C:/PHASMA 2025 DAQ/PHASMA Python Routines/PHASMA_C_to_Python_convertor_Project"
...
def write_primes():
    ...
    with open("C:\PHASMA 2025 DAQ\PHASMA Python Routines\PHASMA_C_to_Python_convertor_Project\primeoutput.txt", "w") as f:
        for p in primes:
            f.write(f"{p}\n")
    f.close()
