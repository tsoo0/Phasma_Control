...
basedir = "D:/TANSTAAFL/To Do/PHASMA DAQ V2025/PHASMA 2025 DAQ/PHASMA Python Routines/PHASMA_C_to_Python_convertor_Project"
...
#dummy rountine just for testing
def write_primes():
    primes = []
    num = 2
    while len(primes) < 10:
    ...
    with open("D:\\TANSTAAFL\\To Do\\PHASMA DAQ V2025\\PHASMA 2025 DAQ\\t-DAQ Instruments\\PHASMA Python Routines\\primeoutput.txt", "w") as f:
        for p in primes:
            f.write(f"{p}\n")
    f.close()
