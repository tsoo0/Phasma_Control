...
#include <nivxi.h>
#include <ansi_c.h>
#include <Joerger VTR10012.h>
#include <Joerger VTR10014.h> 
#include <utility.h>
#include <userint.h>
...
void JoergerVTR10012_acquire(int channel,int rlength, double signal_array1[], double signal_array2[])
{
	int		source_channel;
	int		i;
	double 	*data_array1;
...
void JoergerVTR10014_acquire(int channel,int rlength, double signal_array1[], double signal_array2[])
{
	int		source_channel;
	int		i;
